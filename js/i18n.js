...
export const translations = {
    es: {
        ...
        awareness_header_title: "Analizar cabeceras de un correo (opcional)",
        awareness_header_desc: "¿Recibiste un correo de simulación? Pega sus cabeceras completas para detectar el vendor con alta confianza, incluido Microsoft AST (que no deja rastro DNS).",
    ...
    en: {
        ...
        awareness_header_title: "Analyze an email's headers (optional)",
        awareness_header_desc: "Got a simulation email? Paste its full headers to detect the vendor with high confidence, including Microsoft AST (which leaves no DNS trace).",
